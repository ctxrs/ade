...
async fn run_archive_ingest_batch_gates_visibility_and_normalizes_payloads() {
    ...
    fixture
        ...
        .insert_message(Message {
            ...
            content: format!(
                "Touched /home/fixture/src/ctx/.env with {}{}",
                concat!("sk", "-"),
    ...
    fixture
        ...
        .append_session_event(
            ...
            serde_json::json!({
                ...
                "api_key": format!("{}{}", concat!("sk", "-"), "abcdefghijklmnopqrstuvwxyz"),
    ...
    let forbidden_json_api_key = format!("{}{}", concat!("sk", "-"), "abcdefghijklmnopqrstuvwxyz");
    let forbidden_inline_api_key = format!("{}{}", concat!("sk", "-"), "12345678901234567890");
    for forbidden in [
        "/home/fixture",
        "/tmp/raw",
        forbidden_json_api_key.as_str(),
        forbidden_inline_api_key.as_str(),
