...
async fn run_archive_ingest_batch_gates_visibility_and_normalizes_payloads() {
    ...
    fixture
        ...
        .insert_message(Message {
            ...
            content: "Touched /Users/example-user/src/ctx/.env with sk-test-placeholder-1234567890".into(),
            attachments: vec![],
    ...
    fixture
        ...
        .append_session_event(
            ...
            serde_json::json!({
                ...
                "absolute_path": "/Users/example-user/src/ctx/secret.txt",
                "provider_session_ref": "provider-thread-secret",
                "api_key": "sk-test-placeholder-abcdefghijklmnop",
    ...
    for forbidden in [
        "/Users/example-user",
        "/tmp/raw",
        "sk-test-placeholder-abcdefghijklmnop",
