...
pub(in crate::daemon::scheduler::runtime) struct BaseProviderEnvRequest<'a> {
    pub(in crate::daemon::scheduler::runtime) daemon_url: &'a str,
    pub(in crate::daemon::scheduler::runtime) data_root: &'a Path,
    pub(in crate::daemon::scheduler::runtime) session: &'a Session,
    pub(in crate::daemon::scheduler::runtime) full_model_id: &'a str,
    pub(in crate::daemon::scheduler::runtime) provider_control_mode: &'a ProviderControlMode,
}

pub(in crate::daemon::scheduler::runtime) fn build_base_provider_env(
...
pub(in crate::daemon::scheduler::runtime) fn provider_mode_id_for(
    provider_id: &str,
