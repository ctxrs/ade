...
use super::super::context::{
    context_window_for_run, context_window_for_run_in_store, worktree_path_for_child,
    worktree_path_for_child_in_store, LegacyContextWindowRejectCounter,
};
use super::super::{
    internal_api_error, wait_for_run_assistant_message, wait_for_run_assistant_message_in_store,
    AgentDetail, AgentResult, AgentSummary, ApiResult, PersistedSubagentPrompt, SpawnedChild,
};
    ...
    AgentDetail {
        agent: AgentSummary {
            ...
            state: agent_active_state(match persisted.saved_message.delivery {
                ctx_core::models::MessageDelivery::Queued => {
                    ctx_core::models::SessionTurnStatus::Queued
                }
                ctx_core::models::MessageDelivery::Immediate => {
                    ctx_core::models::SessionTurnStatus::Starting
                }
            })
            .to_string(),
