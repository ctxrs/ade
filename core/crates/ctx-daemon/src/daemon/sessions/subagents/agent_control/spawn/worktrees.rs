...
use ctx_core::models::{
    SandboxBinding, VcsKind, Workspace, Worktree, WorktreeBootstrapNotice, WorktreeBootstrapStatus,
};
...
use super::super::super::{api_error, internal_api_error, SubagentErrorKind};
...
pub(in crate::daemon) struct SubagentSpawnWorktreeHostParts {
    ...
    pub(in crate::daemon) attachment_materialization:
        Arc<WorkspaceAttachmentMaterializationRuntime>,
}

impl SubagentSpawnWorktreeHost {
    pub(in crate::daemon) fn new(parts: SubagentSpawnWorktreeHostParts) -> Self {
        let attachments = Arc::new(WorkspaceAttachmentsRuntime::new(
            parts.data_root.clone(),
            parts.daemon_url.clone(),
            parts.global_store.clone(),
            parts.workspace_stores.clone(),
            Arc::clone(&parts.harness),
            parts.attachment_materialization,
        ));
...
#[async_trait]
impl WorktreeDataPlaneHost for SubagentSpawnWorktreeHost {
...
#[async_trait]
impl WorktreeBootstrapHost for SubagentSpawnWorktreeHost {
...
impl SubagentSpawnHost {
    ...
    pub(in crate::daemon) async fn create_subagent_worktree(
        ...
        let (wt_path, sandbox_binding) = self
            ...
            .await
            .map_err(super::super::super::errors::internal_request_or_policy_error)?;
