...
const MIRROR_PATH_PREFIX: &str = "/functions/v1/download/managed-runtimes/";
const MIRROR_STORAGE_HOST: &str = "api.ctx.rs";
const MIRROR_STORAGE_PATH_PREFIX: &str =
    "/storage/v1/object/public/releases/artifacts/managed-runtimes/";
...
const NODE_RUNTIME_ARCHIVES: &[ManagedRuntimeArchiveSpec] = &[
    ManagedRuntimeArchiveSpec {
        ...
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/node/24.15.0/node-v24.15.0-darwin-arm64.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/node/24.15.0/node-v24.15.0-darwin-x64.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/node/24.15.0/node-v24.15.0-linux-arm64.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/node/24.15.0/node-v24.15.0-linux-x64.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/node/24.15.0/node-v24.15.0-win-arm64.zip",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::Zip,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/node/24.15.0/node-v24.15.0-win-x64.zip",
...
const PYTHON_RUNTIME_ARCHIVES: &[ManagedRuntimeArchiveSpec] = &[
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.13.13/20260414/cpython-3.13.13+20260414-aarch64-apple-darwin-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.13.13/20260414/cpython-3.13.13+20260414-x86_64-apple-darwin-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.13.13/20260414/cpython-3.13.13+20260414-aarch64-unknown-linux-gnu-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.13.13/20260414/cpython-3.13.13+20260414-x86_64-unknown-linux-gnu-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.13.13/20260414/cpython-3.13.13+20260414-aarch64-pc-windows-msvc-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.13.13/20260414/cpython-3.13.13+20260414-x86_64-pc-windows-msvc-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.12.13/20260303/cpython-3.12.13+20260303-aarch64-apple-darwin-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.12.13/20260303/cpython-3.12.13+20260303-x86_64-apple-darwin-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.12.13/20260303/cpython-3.12.13+20260303-aarch64-unknown-linux-gnu-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.12.13/20260303/cpython-3.12.13+20260303-x86_64-unknown-linux-gnu-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.12.13/20260303/cpython-3.12.13+20260303-aarch64-pc-windows-msvc-install_only.tar.gz",
    ...
    ManagedRuntimeArchiveSpec {
        ...
        archive_kind: ManagedRuntimeArchiveKind::TarGz,
        mirror_url: "https://api.ctx.rs/functions/v1/download/managed-runtimes/python/3.12.13/20260303/cpython-3.12.13+20260303-x86_64-pc-windows-msvc-install_only.tar.gz",
...
pub(crate) fn runtime_download_url_allowed(url: &url::Url) -> bool {
    ...
    match url.host_str() {
        Some(MIRROR_HOST) => url.path().starts_with(MIRROR_PATH_PREFIX),
        Some(MIRROR_STORAGE_HOST) => url.path().starts_with(MIRROR_STORAGE_PATH_PREFIX),
        _ => false,
    }
}
