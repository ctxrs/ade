...
use context_providers::acp::{AcpAgentConfig, AcpClientConfig, AcpPromptRequest, AcpSessionPool};
...
async fn acp_concurrency_routes_updates_per_session() {
    ...
    let client = AcpClientConfig {
        client_name: "context-test".to_string(),
        client_title: "Context Test".to_string(),
