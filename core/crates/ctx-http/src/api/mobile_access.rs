...
pub(super) async fn list_mobile_connection_profiles(
...
pub(super) async fn create_mobile_connection_profile(
    State(state): State<Arc<AppState>>,
    mobile_auth: Option<Extension<MobileAuthContext>>,
...
#[derive(Debug, Deserialize)]
pub(super) struct MobileSecureEnvelope {
    pub(super) device_id: String,
    pub(super) seq: i64,
    pub(super) nonce: String,
    pub(super) ciphertext: String,
...
#[derive(Debug, Deserialize)]
pub(super) struct MobileSecureStreamQuery {
    pub(super) device_id: String,
}
...
pub(super) async fn delete_mobile_connection_profile(
    State(state): State<Arc<AppState>>,
    mobile_auth: Option<Extension<MobileAuthContext>>,
    Path(id): Path<String>,
...
pub(super) async fn list_mobile_devices_for_profile(
    State(state): State<Arc<AppState>>,
    mobile_auth: Option<Extension<MobileAuthContext>>,
    Path(id): Path<String>,
