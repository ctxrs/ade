        ...
        loop {
            tokio::select! {
                ...
                event = rx.recv() => {
                    ...
                    let backlog_exceeded = pending.push(event).await.is_err() || pending.is_at_capacity().await;
                ...
                .await
            {
                ...
                Err(_) => {
                    let latest = store
                        ...
                        .await
                        .unwrap_or(last_sent);
                    if crate::fault_injection::maybe_fail("ctx_http.send_secure_workspace_gap")
                        .is_err()
                    {
                        return Err(());
                    }
