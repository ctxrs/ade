...
pub use manifest::{
    ...
    in_place_update_capability, is_update_available, join_url, normalize_version_str, platform_key,
    platform_supported, release_manifest_url, ReleaseArtifact, ReleaseManifest, ReleasePlatform,
};
