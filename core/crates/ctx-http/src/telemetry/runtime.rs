...
use super::{
    TelemetryConfig, TelemetryDelivery, TelemetryEvent, TelemetryOriginRuntime, TELEMETRY_LOG_FILE,
    TELEMETRY_REQUEST_TIMEOUT, TELEMETRY_STATE_FILE,
};
...
pub(crate) struct TelemetryStateFile {
...
pub(crate) fn telemetry_state_path(data_root: &Path) -> PathBuf {
...
pub(crate) async fn load_or_create_install_id(data_root: &Path) -> Option<String> {
