...
impl WorkspacesHandle {
    pub(crate) async fn submit_merge_queue_entry(
        &self,
        params: MergeQueueSubmitParams,
    ) -> Result<MergeQueueEntry> {
    ...
    pub(crate) async fn cancel_merge_queue_entry(
        &self,
        workspace_id: WorkspaceId,
        entry_id: MergeQueueEntryId,
    ) -> Result<MergeQueueEntry> {
    ...
    pub(crate) async fn retry_merge_queue_entry(
        &self,
        workspace_id: WorkspaceId,
        entry_id: MergeQueueEntryId,
    ) -> Result<MergeQueueEntry> {
    ...
    pub(crate) async fn get_workspace_merge_queue_entry(
        &self,
        workspace_id: WorkspaceId,
        entry_id: MergeQueueEntryId,
    ) -> Result<MergeQueueEntry> {
...
#[cfg(test)]
pub(crate) async fn begin_workspace_drain(state: &DaemonState, workspace_id: WorkspaceId) -> bool {
    ctx_merge_queue::begin_workspace_drain::<DaemonState>(state, workspace_id).await
}

#[cfg(test)]
pub(crate) async fn finish_workspace_drain(state: &DaemonState, workspace_id: WorkspaceId) -> bool {
    ctx_merge_queue::finish_workspace_drain::<DaemonState>(state, workspace_id).await
}

#[cfg(test)]
pub(crate) async fn schedule_workspace_drain(state: &Arc<DaemonState>, workspace_id: WorkspaceId) {
