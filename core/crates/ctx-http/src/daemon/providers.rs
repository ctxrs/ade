...
pub(crate) use usage::{load_codex_accounts_usage, load_provider_usage, CodexAccountUsageRecord};
...
impl ProvidersHandle {
    ...
    pub(crate) async fn can_create_loaded_session_for_provider(&self, provider_id: &str) -> bool {
        self.state
            .providers
    ...
    pub(crate) async fn refresh_provider_statuses(&self) -> anyhow::Result<()> {
    ...
    pub(crate) async fn restart_all_provider_adapters(
        &self,
        reason: &str,
    ...
    pub(crate) async fn load_preferred_new_session_models(
        &self,
        workspace_id: WorkspaceId,
    ...
    pub(crate) fn data_root(&self) -> &StdPath {
        &self.state.core.data_root
    }

    pub(crate) async fn authenticate_provider_session(
        &self,
        provider_id: &str,
    ...
    pub(crate) fn amp_login_provider_env(&self, amp_home: &StdPath) -> HashMap<String, String> {
    ...
    pub(crate) fn gemini_login_auth_method_id(&self) -> String {
    ...
    pub(crate) fn qwen_login_provider_env(&self, login_home: &StdPath) -> HashMap<String, String> {
    ...
    pub(crate) async fn start_amp_login_session(&self) -> StartedLoginSession {
        start_amp_login_session(&self.state).await
    }

    pub(crate) async fn amp_login_status(
        &self,
        login_id: &str,
    ...
    pub(crate) async fn set_amp_login_failed(&self, login_id: &str, error: String) {
        set_amp_login_failed(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_amp_login_failed_if_no_error(&self, login_id: &str, error: String) {
        set_amp_login_failed_if_no_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_amp_login_timeout_if_no_error(&self, login_id: &str, error: String) {
        set_amp_login_timeout_if_no_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_amp_login_auth_url(&self, login_id: &str, auth_url: String) {
    ...
    pub(crate) async fn start_gemini_login_session(&self) -> StartedLoginSession {
    ...
    pub(crate) async fn set_gemini_login_failed(&self, login_id: &str, error: String) {
        set_gemini_login_failed(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_gemini_login_failed_if_no_error(&self, login_id: &str, error: String) {
        set_gemini_login_failed_if_no_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_gemini_login_timeout_if_no_error(&self, login_id: &str, error: String) {
        set_gemini_login_timeout_if_no_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_gemini_login_auth_url(&self, login_id: &str, auth_url: String) {
    ...
    pub(crate) async fn start_qwen_login_session(&self) -> StartedLoginSession {
        start_qwen_login_session(&self.state).await
    }

    pub(crate) async fn qwen_login_status(
        &self,
        login_id: &str,
    ...
    pub(crate) async fn set_qwen_login_failed(&self, login_id: &str, error: String) {
        set_qwen_login_failed(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_qwen_login_failed_if_no_error(&self, login_id: &str, error: String) {
        set_qwen_login_failed_if_no_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_qwen_login_timeout_if_no_error(&self, login_id: &str, error: String) {
        set_qwen_login_timeout_if_no_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_qwen_login_auth_url(&self, login_id: &str, auth_url: String) {
    ...
    pub(crate) async fn start_mistral_login_session(&self) -> StartedLoginSession {
        start_mistral_login_session(&self.state).await
    }

    pub(crate) async fn mistral_login_status(
        &self,
        login_id: &str,
    ...
    pub(crate) async fn set_mistral_login_failed(&self, login_id: &str, error: String) {
        set_mistral_login_failed(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_mistral_login_failed_if_no_error(&self, login_id: &str, error: String) {
        set_mistral_login_failed_if_no_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_mistral_login_timeout_if_no_error(
        &self,
        login_id: &str,
        error: String,
    ) {
    ...
    pub(crate) async fn set_mistral_login_auth_url(&self, login_id: &str, auth_url: String) {
    ...
    pub(crate) async fn set_kimi_login_failed(&self, login_id: &str, error: String) {
        set_kimi_login_failed(&self.state, login_id, error).await;
    }

    pub(crate) async fn set_kimi_login_timeout_if_no_error(&self, login_id: &str, error: String) {
    ...
    pub(crate) async fn set_claude_login_auth_url(&self, login_id: &str, auth_url: String) {
    ...
    pub(crate) async fn start_cursor_login_session(&self) -> StartedLoginSession {
    ...
    pub(crate) async fn set_cursor_login_error(&self, login_id: &str, error: String) {
        set_cursor_login_error(&self.state, login_id, error).await;
    }

    pub(crate) async fn update_cursor_login_auth_url(&self, login_id: &str, auth_url: String) {
