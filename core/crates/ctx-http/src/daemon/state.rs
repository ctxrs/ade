...
pub struct ProviderRuntime {
    ...
    pub copilot_login_sessions: Mutex<HashMap<String, provider_accounts::CopilotLoginStatus>>,
    pub auggie_login_sessions: Mutex<HashMap<String, provider_accounts::AuggieLoginStatus>>,
    ...
    pub fn new_with_lsp_config_and_flags(
        ...
        Self {
            ...
            providers: ProviderRuntime {
                ...
                copilot_login_sessions: Mutex::new(HashMap::new()),
                auggie_login_sessions: Mutex::new(HashMap::new()),
