...
impl AppState {
    ...
    fn mirrored_install_event(
        ...
        InstallProgressEvent {
            ...
            // Mirrored prerequisite progress is only a wait-state hint for the dependent install.
            // Do not copy raw byte counters from the source install, otherwise the dependent
            // install can jump to 100% while it is still blocked on prerequisite work.
            bytes: None,
            total_bytes: None,
            attempt: None,
