...
pub(crate) enum SessionImageBlobStoreError {
    PayloadTooLarge,
...
#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub(crate) enum DemoSeedTranscriptError {
    SessionNotFound,
...
#[derive(Debug)]
pub(crate) enum SetSessionModeError {
    NotFound,
    BadRequest,
    Internal,
}
...
#[derive(Debug)]
pub(crate) enum GenerateSessionTitleError {
    NotFound,
    PromptRequired,
    Skipped,
...
pub(crate) struct PostUserMessageInput {
    pub(crate) message_id: MessageId,
    pub(crate) turn_id: TurnId,
    pub(crate) client_supplied_ids: bool,
    pub(crate) content: String,
    pub(crate) requested_delivery: Option<MessageDelivery>,
    pub(crate) attachments: Vec<MessageAttachment>,
    pub(crate) queued_messages_enabled: bool,
    pub(crate) run_id_header: Option<String>,
}

#[derive(Debug)]
pub(crate) enum PostUserMessageError {
    BadRequest(String),
    Conflict(String),
    NotFound(String),
...
impl SessionsHandle {
    ...
    pub(crate) async fn get_workspace_id_for_task(
        &self,
        task_id: TaskId,
    ...
    pub(crate) async fn get_workspace_id_for_session(
        &self,
    ...
    pub(crate) async fn get_session_for_artifacts(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn get_session_worktree(&self, session: &Session) -> Result<Option<Worktree>> {
        let store = self.store_for_session(session.id).await?;
        store.get_worktree(session.worktree_id).await
    }

    pub(crate) async fn get_session_artifact_for_download(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn list_session_artifacts_for_route(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn replace_session_artifacts_and_publish(
        &self,
        session: &Session,
        artifacts: &[Artifact],
    ) -> Result<()> {
    ...
    pub(crate) async fn seed_demo_transcript(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn list_session_events_page(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn list_session_turn_tools_for_request(
        &self,
        session_id: SessionId,
        turn_id: TurnId,
    ...
    pub(crate) async fn load_session_head_snapshot_from_store(
        &self,
        session_id: SessionId,
        limit: u32,
        include_events: bool,
    ...
    pub(crate) async fn list_session_subagents_for_request(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn list_session_subagent_invocations_for_request(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn get_session_subagent_invocation_for_request(
        &self,
        session_id: SessionId,
        invocation_id: &str,
    ...
    pub(crate) async fn load_session_vcs_parts(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn persist_session_git_status_summary(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn emit_session_started_observability_for_task(
        &self,
        session: &Session,
        task: &Task,
    ) {
    ...
    pub(crate) async fn upsert_workspace_task_index(
        &self,
        task_id: TaskId,
        workspace_id: WorkspaceId,
    ) -> Result<()> {
    ...
    pub(crate) async fn upsert_workspace_session_index(
        &self,
        session_id: SessionId,
        workspace_id: WorkspaceId,
    ) -> Result<()> {
    ...
    pub(crate) async fn authenticate_session_for_request(
        &self,
        session_id: SessionId,
        method_id: Option<String>,
    ) -> Result<(), auth::SessionAuthError> {
    ...
    pub(crate) async fn set_session_mode_for_request(
        &self,
        session_id: SessionId,
        mode_id: String,
    ...
    pub(crate) async fn generate_session_title_for_request(
        &self,
        session_id: SessionId,
    ...
    pub(crate) async fn post_user_message_for_request(
        &self,
        session_id: SessionId,
    ...
    pub(crate) fn session_tool_output_spool_dir(&self, session_id: SessionId) -> PathBuf {
        self.state
            .core
    ...
    pub(crate) async fn post_message_update_drain_reason(&self) -> Option<String> {
    ...
    pub(crate) async fn effective_install_target_for_environment(
        &self,
        workspace_id: WorkspaceId,
    ...
    pub(crate) async fn emit_session_started_signals(
        &self,
        session: &Session,
    ...
    pub(crate) async fn is_workspace_deleting(&self, workspace_id: WorkspaceId) -> bool {
        self.state
            .core
            .stores
    ...
    pub(crate) async fn cached_session_head_for_request(
        &self,
        session_id: SessionId,
        include_events: bool,
        limit: u32,
    ...
    pub(crate) async fn update_session_head_cache(
        &self,
    ...
    pub(crate) fn record_session_head_recovery_metrics(
        &self,
        source: &'static str,
        result: &'static str,
        elapsed: Duration,
    ...
    pub(crate) async fn worktree_has_vcs_repo(&self, worktree: &Worktree) -> anyhow::Result<bool> {
    ...
    pub(crate) async fn resolve_worktree_commit(
        &self,
        worktree: &Worktree,
        revision: &str,
    ...
    pub(crate) async fn resolve_worktree_diff_base(
        &self,
        worktree: &Worktree,
    ...
    pub(crate) async fn store_inline_image_blob(
        &self,
        bytes: &[u8],
        mime_type: &str,
        name: Option<&str>,
    ...
    pub(crate) async fn session_artifact_path_is_accessible(
        &self,
        store: &Store,
        session: &Session,
        path: &Path,
