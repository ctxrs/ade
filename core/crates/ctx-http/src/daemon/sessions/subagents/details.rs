...
use super::{
    api_error, internal_api_error, wait_for_run_assistant_message, ApiResult,
    PersistedSubagentPrompt, SpawnedChild, SubagentErrorKind,
};

pub(super) fn encode_agent_ref(session_id: SessionId) -> String {
    format!(
        "agent_{}",
...
pub(super) fn encode_run_ref(run_id: RunId) -> String {
    format!(
        "run_{}",
...
pub(super) fn agent_delivery_label(delivery: &MessageDelivery) -> &'static str {
    match delivery {
...
pub(super) fn is_active_turn_status(status: &SessionTurnStatus) -> bool {
    matches!(
        status,
        SessionTurnStatus::Queued | SessionTurnStatus::Starting | SessionTurnStatus::Running
    )
...
pub(super) async fn resolve_child_agent_session(
    store: &ctx_store::Store,
...
pub(super) async fn build_agent_summary(
    store: &ctx_store::Store,
    session_id: SessionId,
    session_title: &str,
    inactivity_timeout: Duration,
...
pub(super) async fn build_agent_detail(
    state: &Arc<AppState>,
    store: &ctx_store::Store,
    parent: &ctx_core::models::Session,
...
pub(super) async fn build_enqueued_agent_detail(
    state: &Arc<AppState>,
    parent: &ctx_core::models::Session,
    session: &ctx_core::models::Session,
...
pub(super) fn build_spawned_agent_detail(spawned: &SpawnedChild) -> AgentDetail {
...
pub(super) async fn collect_wait_targets(
    store: &ctx_store::Store,
    parent: &ctx_core::models::Session,
    agent_ids: &[String],
