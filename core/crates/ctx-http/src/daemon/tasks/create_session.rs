...
#[derive(Debug, Clone)]
pub(crate) struct CreateTaskSessionInput {
    pub(crate) id: Option<String>,
    pub(crate) provider_id: String,
    pub(crate) model_id: String,
    pub(crate) reasoning_effort: Option<String>,
    pub(crate) remember_model_preference: bool,
    pub(crate) parent_session_id: Option<String>,
    pub(crate) relationship: Option<String>,
    pub(crate) initial_prompt: Option<String>,
    pub(crate) initial_message_id: Option<String>,
    pub(crate) initial_turn_id: Option<String>,
...
impl CreateTaskSessionInput {
    pub(crate) fn from_default_seed(seed: DefaultSessionSeed) -> Self {
        Self {
            id: None,
...
pub(crate) struct DefaultSessionSeed {
    pub(crate) provider_id: String,
    pub(crate) model_id: String,
    pub(crate) reasoning_effort: Option<String>,
...
#[derive(Debug)]
pub(crate) enum TaskSessionCreateError {
    BadRequest,
    NotFound,
    Conflict,
...
impl TasksHandle {
    pub(crate) async fn create_session_for_task(
        &self,
        task_id: TaskId,
    ...
    pub(crate) async fn create_session_for_loaded_task(
        &self,
        store: Store,
        task: Task,
        workspace: Workspace,
