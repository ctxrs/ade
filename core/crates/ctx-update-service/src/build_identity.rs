...
"#,
        ...
        let identity = load_build_identity("9.9.9-test").expect("load compile-time identity");
...
"#,
        ...
        let identity = load_build_identity("9.9.9-test").expect("load explicit identity");
