...
use context_core::models::{Workspace, Worktree};
use context_providers::adapters::ProviderProcessInfo;
...
impl ResourceSampler {
    ...
    pub fn processes_snapshot(
        ...
        let daemon = aggregate_process(&self.system, &children, daemon_pid, "Context daemon");
