...
const RATCHETED_FILE_LIMITS = [
  ...
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/mod.rs",
    limit: 260,
  },
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/core.rs",
    limit: 80,
  },
  {
  ...
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/execution_deps.rs",
    limit: 80,
  },
  {
  ...
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/route_graph_parts.rs",
    limit: 200,
  },
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/session_deps.rs",
    limit: 160,
  },
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/sessions.rs",
    limit: 470,
  },
  {
  ...
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/test_helpers.rs",
    limit: 50,
  },
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/transport.rs",
    limit: 90,
  },
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/transport_deps.rs",
    limit: 110,
  },
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/workspace.rs",
    limit: 390,
  },
  {
    path: "core/crates/ctx-daemon/src/daemon/route_builders/workspace_deps.rs",
    limit: 190,
  },
  {
