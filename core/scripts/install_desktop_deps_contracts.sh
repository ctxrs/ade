...
resolve_repo_root() {
  ...
  echo "failed to locate Bazel repo root for install desktop deps contracts" >&2
  return 1
}

REPO_ROOT="$(resolve_repo_root)"

exec bash "${REPO_ROOT}/scripts/tests/install_desktop_deps_linux_ubuntu_contract.sh"
