...
function main() {
  ...
  run(
    ...
    [
      ...
      "scripts/release_preflight_proof_run.test.cjs",
      ...
      "scripts/buildbuddy_release_contract.test.cjs",
      ...
      "scripts/rust_cache_wrapper_contract.test.cjs",
      "scripts/run_buildbuddy_release.test.cjs",
