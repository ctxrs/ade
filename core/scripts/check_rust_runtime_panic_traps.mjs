...
const SCOPE_FILES = [
  ...
  "apps/desktop/src-tauri/src/desktop_ssh/mod.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/commands.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/model.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/transport.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/probe.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/auth.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/planner.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/install.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/tunnel.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/connect.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/update.rs",
  "apps/desktop/src-tauri/src/desktop_ssh/jobs.rs",
