  ...
  return [
    {
      ...
      entrypointType: "core-package-script",
      entrypoint: "source:file-size:enforce",
      surface: "contract",
      oracle: "budget",
      world: "hermetic",
      cost: "tiny",
      ...
      dependencyCrates: [],
      notes: "Hard repository invariant that prevents production source files from growing beyond the approved size budget.",
      exception: "Intentional script-local budget guard until it is moved behind a Bazel target; it remains promotion-blocking because file-size failures make later agent work noisy.",
    },
    {
