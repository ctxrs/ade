...
function buildStaticEntries() {
  return [
    ...
    },
    {
      ...
      dependencyCrates: [],
      notes: "Buildkite-owned release finalize boundary that consumes staged platform archives and emits release evidence.",
      exception: "",
    },
    {
    ...
    {
      id: "repo-contracts.nightly-scaffold-disabled",
      title: "Nightly scaffold disabled",
      family: "repo-contracts",
      entrypointType: "repo-shell-script",
      entrypoint: "scripts/buildkite/run_nightly_scaffold_disabled.sh",
      surface: "contract",
      oracle: "static-contract",
      world: "hermetic",
      cost: "tiny",
      ...
      owner: "ci-release",
      sourceGlobs: [
        ".buildkite/pipelines/nightly.yml",
        "scripts/buildkite/run_nightly_scaffold_disabled.sh",
      ],
      dependencyCrates: [],
      notes: "Checked-in placeholder for the disabled nightly pipeline until nightly-breadth is enabled for real.",
      exception: "",
    },
    {
