...
function buildStaticEntries() {
  return [
    ...
    },
    {
      ...
      dependencyCrates: [],
      notes: "Primary hermetic app/web unit and component gate, excluding the dedicated pretext measurement slice. Affected mode also pulls this gate for extracted session supervisor package changes because the app consumes that package.",
      exception: "",
      alwaysOnProfiles: ["checkin"],
    },
    {
