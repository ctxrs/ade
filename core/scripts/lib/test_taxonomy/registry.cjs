...
function buildStaticEntries() {
  return [
    ...
    },
    {
      ...
      dependencyCrates: [],
      notes: "Focused deterministic transcript measurement, markdown wrapping, and pretext virtualizer unit coverage.",
      exception: "",
    ...
    {
      id: "web-workbench.web-unit-foundation",
      title: "Web foundation unit tests",
      family: "web-workbench",
      entrypointType: "core-package-script",
      entrypoint: "bazel:web:unit:non-pretext:foundation",
      surface: "unit",
      oracle: "direct-assertion",
      world: "hermetic",
      cost: "fast",
      ...
      dependencyCrates: [],
      notes: "Hermetic app/web unit coverage for shared foundation, state, config, and utility surfaces outside the workbench page tree.",
      exception: "",
      alwaysOnProfiles: ["checkin"],
    },
    {
    ...
    {
      id: "web-workbench.web-unit-workbench",
      title: "Web workbench unit tests",
      family: "web-workbench",
      entrypointType: "core-package-script",
      entrypoint: "bazel:web:unit:non-pretext:workbench",
      surface: "unit",
      oracle: "direct-assertion",
      world: "hermetic",
      cost: "fast",
      ...
      dependencyCrates: [],
      notes: "Hermetic app/web unit coverage for the main workbench/page/component surface outside the dedicated pretext measurement slice.",
      exception: "",
      alwaysOnProfiles: ["checkin"],
    },
    {
    ...
    },
    {
      ...
      dependencyCrates: [],
      notes: "Fast Apple Silicon preview app boundary for push-to-main desktop feedback.",
