...
function buildStaticEntries() {
  return [
    ...
    },
    {
      ...
      family: "provider-auth",
      entrypointType: "core-package-script",
      entrypoint: "provider-auth:validate",
      surface: "contract",
      oracle: "static-contract",
      world: "hermetic",
      cost: "tiny",
    ...
    },
    {
      ...
      family: "distribution-install",
      entrypointType: "core-package-script",
      entrypoint: "desktop:check:versions",
      surface: "contract",
      oracle: "static-contract",
      world: "hermetic",
      cost: "tiny",
    ...
    },
    {
      ...
      family: "distribution-install",
      entrypointType: "core-package-script",
      entrypoint: "desktop:runtime:lock:check-matrix",
      surface: "contract",
      oracle: "static-contract",
      world: "hermetic",
      cost: "tiny",
    ...
    },
    {
      ...
      family: "distribution-install",
      entrypointType: "core-package-script",
      entrypoint: "desktop:runtime:lock:validate",
      surface: "contract",
      oracle: "static-contract",
      world: "hermetic",
      cost: "tiny",
