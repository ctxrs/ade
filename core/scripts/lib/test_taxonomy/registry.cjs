...
function buildStaticEntries() {
  return [
    ...
    {
      id: "web-workbench.web-unit-workbench-surface",
      title: "Web workbench surface unit tests",
      family: "web-workbench",
      entrypointType: "core-package-script",
      entrypoint: "bazel:web:unit:non-pretext:workbench:surface",
      surface: "unit",
      oracle: "direct-assertion",
      world: "hermetic",
      cost: "fast",
      ...
      dependencyCrates: [],
      notes: "Hermetic app/web unit coverage for root app wiring, components, and non-shell pages outside the dedicated pretext and settings/setup slices.",
      exception: "",
      alwaysOnProfiles: ["checkin"],
    },
    {
