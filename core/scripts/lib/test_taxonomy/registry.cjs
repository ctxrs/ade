...
const RUST_FAMILY_BY_CRATE = {
  ...
  "ctx-http-auth": "web-workbench",
  "ctx-http-test-support": "subagents-orchestration",
  ...
  "ctx-org-policy": "settings-config",
  ...
  "ctx-route-contracts": "web-workbench",
  ...
  "ctx-workspace-attachments": "attachments-artifacts",
  ...
  "ctx-worktree-vcs-service": "repo-vcs",
};
  ...
  return [
    ...
    },
    {
      ...
      sourceGlobs: [
        ...
        "core/scripts/release_public_storage_locked_objects.test.cjs",
    ...
    },
    {
      ...
      sourceGlobs: [
        ...
        "scripts/tests/release_promote_storage_latest_smoke.sh",
        "scripts/tests/updater_contract_validate_smoke.sh",
        "scripts/tests/release_verify_storage_updater_smoke.sh",
    ...
    },
    {
      ...
      sourceGlobs: [
        ...
        "scripts/release_verify_storage.sh",
    ...
    {
      id: "resilience-performance.remote-daemon-ui-network-soak",
      title: "Remote daemon UI network soak",
      family: "resilience-performance",
      entrypointType: "repo-shell-script",
      entrypoint: "scripts/buildkite/run_remote_daemon_ui_network_soak.sh",
      surface: "performance",
      oracle: "budget",
      world: "external-service",
      cost: "soak",
      requirements: ["linux", "browser", "network", "long-running"],
      stability: "stable",
      execution: "script-local",
      owner: "web-workbench",
      sourceGlobs: [
        ".buildkite/pipelines/nightly.yml",
        "scripts/buildkite/run_remote_daemon_ui_network_soak.sh",
        "scripts/dev_hetzner_machine.sh",
        "scripts/updater_e2e_hetzner.sh",
        "core/scripts/buildkite_required_env.cjs",
        "core/scripts/lib/buildkite_required_env.cjs",
        "core/apps/web/e2e/workbench-remote-daemon-stream-load.spec.ts",
        "core/apps/web/e2e/suites/load.txt",
        "core/apps/web/playwright.load.config.ts",
      ],
      dependencyCrates: ["ctx-http", "ctx-mcp"],
      notes: "Nightly Hetzner-backed browser-to-public-daemon soak that records UI-visible freshness, receive/apply lag, and stop latency under remote network load.",
      exception: "Intentional external-service soak; it provisions a disposable real network host and therefore must stay script-local instead of Bazel-addressable.",
    },
    {
