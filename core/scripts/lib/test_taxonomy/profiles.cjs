...
const PROFILES = [
  ...
  },
  {
    ...
    currentExecution: "Canonical nightly breadth union; the scheduled ctx-nightly pipeline currently runs the first Linux-only anomaly and fuzz slices from this profile as separate failure domains.",
    expansionRules: [
