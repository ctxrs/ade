...
const CTX_HTTP_UNIT_SUITES = [
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-repo-onboarding-service/src/workspace_registration.rs",
    ],
  },
  {
    dependencyCrates: ["ctx-session-runtime", "ctx-repo-onboarding-service"],
    family: "workspace-stream",
    name: "unit-tests-lib",
  ...
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-http/src/api/workspaces/active.rs",
      "crates/ctx-daemon/src/daemon/workspaces/**",
      "crates/ctx-http/src/test_support.rs",
    ],
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-http/src/api/workspaces/harness_container.rs",
      "crates/ctx-daemon/src/daemon/workspace_runtime/**",
    ],
  },
  {
    dependencyCrates: ["ctx-session-runtime"],
    ...
    sourceGlobs: [
      "crates/ctx-daemon/src/daemon.rs",
      "crates/ctx-daemon/src/daemon/**",
      "crates/ctx-daemon/src/daemon/scheduler.rs",
      "crates/ctx-daemon/src/daemon/scheduler/**",
    ],
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-daemon/src/daemon/settings.rs",
    ],
  },
  {
    family: "repo-vcs",
...
const CTX_HTTP_SUITES = [
  ...
  ...CTX_HTTP_UNIT_SUITES,
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-daemon/src/daemon/workspaces/stream.rs",
  ...
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-http/src/api/workspaces/registry.rs",
      "crates/ctx-daemon/src/daemon/git_status.rs",
      "crates/ctx-daemon/src/daemon/git_status/**",
      "crates/ctx-daemon/src/daemon/merge_queue.rs",
      "crates/ctx-daemon/src/daemon/merge_queue/**",
      "crates/ctx-daemon/src/daemon/sessions/vcs.rs",
      "crates/ctx-daemon/src/daemon/sessions/vcs_route.rs",
      "crates/ctx-repo-onboarding-service/src/**",
      "crates/ctx-session-vcs-service/src/**",
      "crates/ctx-worktree-bootstrap-service/src/**",
      "crates/ctx-worktree-vcs-service/src/**",
      "crates/ctx-daemon/src/daemon/workspaces/vcs_hooks.rs",
      "crates/ctx-daemon/src/daemon/workspaces/vcs_hooks/**",
  ...
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-worktree-vcs-service/src/file_completions.rs",
  ...
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-worktree-vcs-service/src/file_completions.rs",
      "crates/ctx-daemon/src/daemon/sessions/title_generation.rs",
      "crates/ctx-session-title-service/src/**",
      "crates/ctx-http/src/ops_events.rs",
      "crates/ctx-http/src/order_seq.rs",
  ...
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-http/src/api/workspaces/attachments.rs",
      "crates/ctx-daemon/src/daemon/workspaces/attachments.rs",
  ...
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-daemon/src/daemon/sessions/subagents.rs",
      "crates/ctx-worktree-bootstrap-service/src/**",
