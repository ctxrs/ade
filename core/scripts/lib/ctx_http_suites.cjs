...
const CTX_HTTP_SHARED_SOURCE_GLOBS = [
  ...
  "crates/ctx-http/src/api/extractors.rs",
...
const CTX_HTTP_SUITES = [
  ...
  },
  {
    ...
    sourceGlobs: [
      ...
      "crates/ctx-http/src/harness_runtime.rs",
      ...
      "crates/ctx-http/src/provider_probe.rs",
  ...
  {
    dependencyCrates: ["ctx-core", "ctx-events", "ctx-fs", "ctx-store"],
    name: "repo-vcs",
  ...
  {
    dependencyCrates: ["ctx-core", "ctx-lsp", "ctx-store"],
    name: "lsp",
    description: "LSP, MCP-adjacent editing, and buffer flows",
    sourceGlobs: [
      "crates/ctx-http/src/api/lsp.rs",
      "crates/ctx-http/src/api/lsp/**",
      "crates/ctx-http/src/api/sessions/file_completions.rs",
      "crates/ctx-http/src/buffers.rs",
      "crates/ctx-http/src/edit_plans.rs",
      "crates/ctx-http/src/installer/lsp.rs",
      "crates/ctx-http/src/lsp_catalog.json",
      "crates/ctx-http/src/lsp_catalog.rs",
    ],
    testFiles: [
      "buffers_http_e2e",
  ...
  {
    dependencyCrates: ["ctx-core", "ctx-events", "ctx-store", "ctx-worker-protocol"],
    name: "turns-terminal",
