...
use gpui::{ClickEvent, Context, FocusHandle, Image, ImageFormat, KeyDownEvent, Window};
...
use super::models::{
    build_message_items, is_image_artifact, is_text_artifact, session_info_from_head,
    session_info_from_summary, MessageItem, SessionInfo,
};
