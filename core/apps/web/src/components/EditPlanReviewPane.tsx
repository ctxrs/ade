...
export function EditPlanReviewPane({
  plan,
  sessionId,
  onPlanUpdated,
  onFileSaved,
  ...
  sessionId?: string;
  onPlanUpdated: (plan: EditPlanSummary) => void;
  onFileSaved?: () => void;
  labels?: Partial<{
    title: string;
  ...
  return (
    <div className="diff-pane">
      <div className="diff-header">
        <h2>{labels?.title ?? "Pending LSP Changes"}</h2>
                ...
                {isOpen && (
                  <div className="diff-file-body">
                    <div className="diff-file-actions">
                      <button
                        type="button"
                        disabled={fileBusy || busyKey !== null}
                            ...
                            <div key={h.key} className="diff-hunk">
                              <div className="diff-hunk-top">
                                ...
                                <div className="row" style={{ gap: 6 }}>
                                  <button
                                    type="button"
                                    disabled={hunkBusy || busyKey !== null}
