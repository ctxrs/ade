    ...
    <GeneralSection>
      <div className="settings-preferences-flat">
        ...
        <div className="settings-preferences-group">
          <div className="settings-row settings-row-stack">
            <div className="settings-row-left">
              ...
              <div className="settings-row-desc">Attach git repositories that are mounted into every worktree.</div>
            </div>
          ...
          <div className="settings-row settings-row-stack">
            <div className="settings-row-left">
              <div className="settings-row-title">Configured attachments</div>
            </div>
        ...
        <div className="settings-preferences-group">
          <div className="settings-row settings-row-stack">
            <div className="settings-row-left">
              <div className="settings-row-title">Docs</div>
              <div className="settings-row-desc">
                Mirror docs sites so agents can reference them from local workspace paths.
              </div>
            </div>
            <div className="settings-row-field settings-attachments-panel">
              <div className="settings-attachments-form">
