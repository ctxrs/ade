...
export const SESSION_THREAD_MARKDOWN_BODY_LINE_HEIGHT_PX = 21;
...
export const SESSION_THREAD_TURN_HEADER_BUBBLE_PADDING_BLOCK_PX = 8;
export const SESSION_THREAD_TURN_HEADER_BUBBLE_PADDING_INLINE_PX = 10;
export const SESSION_THREAD_TURN_HEADER_BUBBLE_BORDER_WIDTH_PX = 1;
export const SESSION_THREAD_TURN_HEADER_COPY_GUTTER_PX = 24;
export const SESSION_THREAD_TURN_HEADER_COLLAPSED_MAX_HEIGHT_PX = 66;
