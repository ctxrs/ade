...
const SOFT_BREAK_MARKDOWN_REGRESSIONS: SoftBreakMarkdownSample[] = [
  ...
  },
  {
    ...
    width: 788,
    markdown: [
      "That split can make sense for a layout sample.",
      "",
      "Use two neutral groups:",
      "",
      "- **first fragment**: short marker",
      "- **following prose**: longer tail",
      "",
      "The sample should keep:",
      "- a visible inline-code chip near the width edge",
      "- a second chip after a collapsed whitespace seam",
      "",
      "A stable width set is:",
      "",
      "- **short marker**: `12-24px`",
      "- **long marker**: `72px`",
      "",
      "For a mixed paragraph, keep:",
      "",
      "- `alpha` before the seam",
      "- `beta` after the seam",
      "",
      "Then add an explicit **continuation case** for a code group that starts on the next line.",
      "",
      "**How to exercise the sample**",
      "Use a fixed paragraph and compare the prepared line count with the browser result:",
      "",
      "- keep the width constant",
      "- preserve the same code markers",
      "- record only the rendered height",
      "",
      "That means:",
      "1. render the first marker",
      "2. render the prose tail",
      "3. compare the wrapped continuation",
      "4. keep the sample deterministic",
      "",
      "The sample is more useful when its line shape stays stable across engines.",
      "",
      "**Important caveat**",
      "Do not shorten the code markers unless the replacement still exercises the seam:",
      "",
      "- preserve the inline-code decoration",
      "- preserve the whitespace before the tail",
      "- preserve the punctuation after the tail",
      "- preserve a fresh-line continuation",
      "",
      "The neutral rule is:",
      "",
      "- **normal case**: keep the seam in the paragraph",
      "- **continuation case**: move the whole chip when it cannot fit",
      "- **never**: split the neutral marker without a measured reason",
      "",
