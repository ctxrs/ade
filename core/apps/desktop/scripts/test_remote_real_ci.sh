...
RUN_FIRST_TURN="${CTX_AUTOMATION_REMOTE_RUN_FIRST_TURN:-0}"
...
important env:
  ...
  CTX_AUTOMATION_REMOTE_RUN_FIRST_TURN=1|0
...
if [[ "${RUN_HOST}" == "1" ]]; then
  ...
  run_lane \
    ...
    "CTX_AUTOMATION_REMOTE_RUN_FIRST_TURN=${RUN_FIRST_TURN}" \
...

{
  ...
  echo "run_first_turn=${RUN_FIRST_TURN}"
