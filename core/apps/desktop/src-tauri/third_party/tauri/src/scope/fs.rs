...
mod tests {
  ...
  fn path_is_escaped() {
    ...
    #[cfg(unix)]
    {
      scope.allow_directory("/home/example-user/**", false).unwrap();
      assert!(scope.is_allowed("/home/example-user/**"));
      assert!(scope.is_allowed("/home/example-user/**/file"));
      assert!(!scope.is_allowed("/home/example-user/anyfile"));
    }
    #[cfg(windows)]
    {
    ...
    #[cfg(unix)]
    {
      scope.allow_file("/home/example-user/**").unwrap();
      assert!(scope.is_allowed("/home/example-user/**"));
      assert!(!scope.is_allowed("/home/example-user/**/file"));
      assert!(!scope.is_allowed("/home/example-user/anyfile"));
    }
    ...
    #[cfg(unix)]
    {
      scope.allow_directory("/home/example-user", true).unwrap();
      scope.forbid_directory("/home/example-user/**", false).unwrap();
      assert!(!scope.is_allowed("/home/example-user/**"));
      assert!(!scope.is_allowed("/home/example-user/**/file"));
      assert!(scope.is_allowed("/home/example-user/**/inner/file"));
      assert!(scope.is_allowed("/home/example-user/inner/folder/anyfile"));
      assert!(scope.is_allowed("/home/example-user/anyfile"));
    }
    #[cfg(windows)]
    {
    ...
    {
      scope.allow_directory("/home/example-user", true).unwrap();
      scope.forbid_file("/home/example-user/**").unwrap();
      assert!(!scope.is_allowed("/home/example-user/**"));
      assert!(scope.is_allowed("/home/example-user/**/file"));
      assert!(scope.is_allowed("/home/example-user/**/inner/file"));
      assert!(scope.is_allowed("/home/example-user/anyfile"));
