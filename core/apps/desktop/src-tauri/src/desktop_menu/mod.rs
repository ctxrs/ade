...
pub(super) use ids::{
    ...
    CMD_FILE_NEW_WINDOW, CMD_FILE_NEW_WORKSPACE, CMD_FILE_OPEN_RECENT,
    CMD_GO_AGENT_HARNESSES, CMD_GO_DIAGNOSTICS, CMD_GO_LAUNCHER, CMD_GO_SETTINGS,
    CMD_GO_WORKSPACE_SETUP, CMD_HELP_CHECK_FOR_UPDATES, CMD_HELP_KEYBOARD_SHORTCUTS,
    CMD_HELP_OPEN_LOGS_FOLDER, CMD_HELP_REPORT_ISSUE, CMD_SESSION_COPY_SESSION_LOG,
    CMD_SESSION_COPY_TASK_ID, CMD_SESSION_COPY_TRANSCRIPT, CMD_SESSION_COPY_WORKTREE_LOCATION,
    CMD_SESSION_INTERRUPT, CMD_SESSION_OPEN_WORKTREE_TERMINAL, CMD_TASK_ARCHIVE_TOGGLE,
    CMD_TASK_DELETE, CMD_TASK_MARK_READ_TOGGLE, CMD_TASK_NEW, CMD_TASK_RENAME,
    CMD_VIEW_FIND_TASKS, CMD_VIEW_TOGGLE_ARTIFACTS, CMD_VIEW_TOGGLE_DEVTOOLS,
    CMD_VIEW_TOGGLE_DIFF, CMD_VIEW_TOGGLE_SESSIONS, CMD_VIEW_TOGGLE_SIDEBAR,
