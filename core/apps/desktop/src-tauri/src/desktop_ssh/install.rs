...
pub(super) fn bootstrap_download_base_url() -> String {
...
pub(super) fn remote_bundle_dir_for_data_dir(remote_data_dir: &str) -> String {
    format!("{}/bundles", remote_data_dir.trim_end_matches('/'))
}

pub(super) fn remote_bundle_backup_dir_for_data_dir(remote_data_dir: &str) -> String {
    format!(
        "{}.pre-update-backup",
