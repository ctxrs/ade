...
CTX_APPIMAGE_PATH="${app_path}" \
CTX_AUTOMATION_SHIPPED_APP=1 \
CTX_AUTOMATION_SHIPPED_APP_DAEMON_DATA_DIR="${workspace_home_dir}/.ctx" \
CTX_AUTOMATION_SHIPPED_APP_BUNDLES_DIR="${bundle_dir}" \
CTX_AUTOMATION_SKIP_APP_BUILD=1 \
CTX_AUTOMATION_SKIP_DESKTOP_PREP_RELEASE=1 \
CTX_AUTOMATION_SCENARIOS="${CTX_AUTOMATION_SCENARIOS:-local-codex-smoke}" \
CTX_AUTOMATION_LOCAL_CODEX_RUN_FIRST_TURN="${CTX_AUTOMATION_LOCAL_CODEX_RUN_FIRST_TURN:-0}" \
CTX_AUTOMATION_LOCAL_CODEX_REQUIRE_FIRST_TURN_SUCCESS="${CTX_AUTOMATION_LOCAL_CODEX_REQUIRE_FIRST_TURN_SUCCESS:-0}" \
