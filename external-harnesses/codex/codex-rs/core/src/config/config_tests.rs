...
projects = { "/Users/example-user/code/codex4" = { trust_level = "trusted", foo = "bar" } , "/Users/example-user/code/codex3" = { trust_level = "trusted" } }
model = "foo""#;
    let mut doc = initial.parse::<DocumentMut>()?;

    // Approve a new directory
    let new_project = Path::new("/Users/example-user/code/codex2");
...
[projects."/Users/example-user/code/codex4"]
trust_level = "trusted"
foo = "bar"

[projects."/Users/example-user/code/codex3"]
trust_level = "trusted"

[projects."/Users/example-user/code/codex2"]
trust_level = "trusted"
"#;
    assert_eq!(contents, expected);
