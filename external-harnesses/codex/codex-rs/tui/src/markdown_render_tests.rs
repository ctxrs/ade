...
fn file_link_hides_destination() {
    let text = render_markdown_text(
        "[codex-rs/tui/src/markdown_render.rs](/Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs)",
    );
...
fn file_link_appends_line_number_when_label_lacks_it() {
    let text = render_markdown_text(
        "[markdown_render.rs](/Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs:74)",
    );
    let expected = Text::from(Line::from_iter([
...
fn file_link_uses_label_for_line_number() {
    let text = render_markdown_text(
        "[markdown_render.rs:74](/Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs:74)",
    );
...
fn file_link_appends_hash_anchor_when_label_lacks_it() {
    let text = render_markdown_text(
        "[markdown_render.rs](file:///Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs#L74C3)",
    );
    let expected = Text::from(Line::from_iter([
        "markdown_render.rs".cyan(),
        ":74:3".cyan(),
...
fn file_link_uses_label_for_hash_anchor() {
    let text = render_markdown_text(
        "[markdown_render.rs#L74C3](file:///Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs#L74C3)",
    );
...
fn file_link_appends_range_when_label_lacks_it() {
    let text = render_markdown_text(
        "[markdown_render.rs](/Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs:74:3-76:9)",
    );
    let expected = Text::from(Line::from_iter([
        "markdown_render.rs".cyan(),
        ":74:3-76:9".cyan(),
...
fn file_link_uses_label_for_range() {
    let text = render_markdown_text(
        "[markdown_render.rs:74:3-76:9](/Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs:74:3-76:9)",
    );
...
fn file_link_appends_hash_range_when_label_lacks_it() {
    let text = render_markdown_text(
        "[markdown_render.rs](file:///Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs#L74C3-L76C9)",
    );
    let expected = Text::from(Line::from_iter([
        "markdown_render.rs".cyan(),
        ":74:3-76:9".cyan(),
...
fn multiline_file_link_label_after_styled_prefix_does_not_panic() {
    let text = render_markdown_text(
        "**bold** plain [foo\nbar](file:///Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs#L74C3)",
    );
    let expected = Text::from_iter([
...
fn file_link_uses_label_for_hash_range() {
    let text = render_markdown_text(
        "[markdown_render.rs#L74C3-L76C9](file:///Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs#L74C3-L76C9)",
    );
...
fn markdown_render_file_link_snapshot() {
    let text = render_markdown_text(
        "See [markdown_render.rs:74](/Users/example-user/code/codex/codex-rs/tui/src/markdown_render.rs:74).",
    );
    let rendered = text
        .lines
        .iter()
